...
if($_SERVER['REQUEST_METHOD'] == "POST")
{
    ...
    $ValIsActive = htmlspecialchars(trim($_POST['ValIsActive']), ENT_QUOTES, "UTF-8");
    ...
    # update data
    $Update  = UPDATE_DATA_PROTRAX_USER($ValUsername,$ValName,$ValCompany,$ValIsActive,$ValType,$ValMnSecurity,$ValMnCostTracking,$ValMnProduction,$ValIsAdmin,$ValMnCCTV,$ValMnReport,$ValMnPPIC,$ValMnOprMachCNC,$ValMnOprMachManual,$ValMnOprFabrication,$ValMnOprFinishing,$ValMnOprQA,$ValMnOprQC,$ValMnOprAssembly,$ValMnOprCuttingMaterial,$ValMnOprPacking,$ValMnOprInjection,$ValMnWarehouse,$ValMnExim,$ValMnKAShift,$ValMnClosedWO,$linkMACHWebTrax);
   ?>
    <script>
