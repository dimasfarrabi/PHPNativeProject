...
if($_SERVER['REQUEST_METHOD'] == "POST")
{
    ...
    if($ValLocation == "PSL")
    {
        if($ValCategory == "IN")
        {
            $QData = GET_DATA_MATERIAL_TRACKING_TBZ_IN($ValDateStart,$ValDateEnd,$linkMACHWebTrax);
        }
        elseif($ValCategory == "OUT")
        {
            $QData = GET_DATA_MATERIAL_TRACKING_TBZ_OUT($ValDateStart,$ValDateEnd,$linkMACHWebTrax);
        }
        else
        {
            $QData = GET_DATA_MATERIAL_TRACKING_TBZ_ALL($ValDateStart,$ValDateEnd,$linkMACHWebTrax);
        }
    ...
    if($ValLocation == "PSM")
    {
        if($ValCategory == "IN")
        {
            $QData = GET_DATA_MATERIAL_TRACKING_TBZ_IN_PSM($ValDateStart,$ValDateEnd);
        }
        elseif($ValCategory == "OUT")
        {
            $QData = GET_DATA_MATERIAL_TRACKING_TBZ_OUT_PSM($ValDateStart,$ValDateEnd);
        }
        else
        {
            $QData = GET_DATA_MATERIAL_TRACKING_TBZ_ALL_PSM($ValDateStart,$ValDateEnd);
        }
    }
