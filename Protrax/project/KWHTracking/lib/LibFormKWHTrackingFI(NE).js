$(document).ready(function () {
    $(".btn-labeled").click(function () {
        ...
        switch (IDName) {
            case "ImportData":
                var NewPage = 'project/KWHTracking/FormImportKWHTrackingFI.php';
                break;
            case "ViewData":
                var NewPage = 'project/KWHTracking/TableKWHTrackingFI.php';
                break;
            case "GenerateData":
                var NewPage = 'project/KWHTracking/FormGenerateDataKWHTrackingFI.php';
                break;
            default:
                alert("Not found!");
                break;
...
function DownloadTemplate() {
    $("#DownloadTemplate").click(function () {
        window.location.href = 'project/KWHTracking/src/srcDownloadTemplateKWHTrackingFI.php?accs=1';
    });
}
function ViewResult() {
    ...
    $("#BtnDownloadResult").click(function () {
        ...
        window.location.href = 'project/KWHTracking/src/srcDownloadKWHTrackingFI.php?str=' + stringval + '&&accs=1';
    });
    $("#BtnViewTable").click(function () {
        ...
        $.ajax({
            url: 'project/KWHTracking/TableKWHTrackingAjaxFI.php',
            dataType: 'text',
            cache: false,
            contentType: false,
            processData: false,
...
function GenerateData() {
    ...
    $("#BtnGenerate").click(function () {
        ...
        formdata.append('ValDateEnd', Date2);
        $.ajax({
            url: 'project/KWHTracking/src/srcGenerateKWHTrackingFI.php',
            dataType: 'text',
            cache: false,
            contentType: false,
            processData: false,
...
function GoToGenerate() {
    $("#BtnMove").click(function () {
        $.ajax({
            url: 'project/KWHTracking/FormGenerateDataKWHTrackingFI.php',
...
function AddOneData()
{
    $("#BtnAdd").click(function(){
        ...
        $.ajax({
            url: 'project/KWHTracking/src/srcAddNewKWHTrackingFI.php',
            dataType: 'text',
            cache: false,
            contentType: false,
            processData: false,
...
function ReloadTable() {
    $.ajax({
        url: 'project/KWHTracking/src/srcReloadTableResultNewKWHTrackingFI.php',
        data: 'data=1',
        dataType: 'html',
        cache: false,
        type: "POST",
