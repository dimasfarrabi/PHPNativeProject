...
if($_SERVER['REQUEST_METHOD'] == "POST")
{
    ...
    {
        # check data
        $QCheck = CHECK_DATA_USAGE_BY_DATE("Slave 1",$ValDate,"FI",$linkHRISWebTrax);    
        $RowCheck = mssql_num_rows($QCheck);
        if($RowCheck == "0")
        {
            # insert data
            INSERT_NEW_DATA_USAGE("Slave 1",$ValDate,$ValUsage,"FI",$linkHRISWebTrax);
        }
        else
        {
            # get data
        ...
        $QDataSlave = GET_SLAVE_USAGE_BY_DATE($ValDate,$ValDate,"FI",$linkHRISWebTrax);
