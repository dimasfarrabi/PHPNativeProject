...
{   
    ...
    $QDataSlave = GET_SLAVE_USAGE_BY_DATE($ValDateStart,$ValDateEnd,"PSL",$linkHRISWebTrax);
    ...
    ?>
<div class="col-sm-12">
    <h5>Generate data from <?php echo $ValDateStart; ?> to <?php echo $ValDateEnd; ?> has been finished.</h5>
</div>
    <?php
}
else
