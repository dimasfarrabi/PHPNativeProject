...
<!-- <script src="project/Report/lib/LibMachineTracking.js"></script> -->
<div class="row">
    <div class="col-md-12">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb breadcrumb-detail ">
                <li class="breadcrumb-item"><a href="home.php">Home</a></li>
                <li class="breadcrumb-item active" aria-current="page">Report : Machine Tracking</li>
            </ol>
        </nav>
    </div>
</div>
                ...
                <div class="card">
                    <div class="card-body pt-2">
                        <div class="row">
                            ...
                            <div class="col-md-6 d-grid mt-2">
                                <button class="btn btn-sm btn-dark" id="BtnDownload">Download</button>
                            </div> 
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="card-body pt-2">
                        <div class="row">
                            ...
                            <div class="col-md-6 d-grid mt-2">
                                <button class="btn btn-sm btn-dark" id="BtnDownloadSeason">Download</button>
                            </div> 
                        </div>
                    </div>
                </div>
...
$(document).ready(function () {
    ...
    $("#BtnDownload").click(function(){
        ...
        window.location.href = 'project/Report/src/DownLoadCSVMachine.php?Used='+Used+'&&StartDate='+StartDate+'&&EndDate='+EndDate+'&&Category='+Category+'&&Half='+Half+'&&Open='+Open+'&&Keywords='+Keywords;
    });
