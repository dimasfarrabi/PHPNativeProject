...
if($_SERVER['REQUEST_METHOD'] == "POST")
{
    ...
    $ValUser = trim(strtoupper(base64_decode($_SESSION['FullNameUserProTrax'])));
    # insert data
    ...
    do 
    {
        ...
        // DELETE_DATA_USAGE_LOG_BY_DATE($Date,$Locations,$linkHRISWebTrax);    # sementara tidak digunakan
