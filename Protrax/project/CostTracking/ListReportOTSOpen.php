...
{   
    ...
    ?>
<div class="col-md-12"><h5><strong>Top 10 Total Cost (<?php echo $ValCostAllocation; ?>)</strong></h5></div>
<div class="col-md-12">
    <div class="table-responsive">
        <table class="table table-bordered table-hover" id="TableTOP10OTS">
            ...
            <tbody>
    <?php
    $QListTop10 = TOP_10_OTS_COST_OPEN($ValType,$ValQuoteSelected,$ValClosedTime,$ValQuoteCategory,$ValCostAllocation,$LinkOpt);
    $No = 1;
    while($RListTop10 = mssql_fetch_assoc($QListTop10))
    {
        ...
        $ValQty = number_format((float)$ValQty, 0, '.', ',');
