...
?>
<script src="project/CostTracking/lib/LibManagePeriodicQuoteCost.js?no=<?php echo base64_encode(date("mdyHis")); ?>"></script>
<div class="row">
    <div class="col-md-12">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb breadcrumb-detail">
                <li class="breadcrumb-item"><a href="home.php">Home</a></li>
                <li class="breadcrumb-item active" aria-current="page">Cost Tracking : Manage Periodic Quote Cost</li>
            </ol>
        </nav>
    </div>
</div>
<div class="row">
    ...
    <div class="col-md-3">
        <div class="row">
            <div class="col-sm-5">
                <label for="FilterQuoteCategory" class="form-label fw-bold pt-1">Quote Category</label>
            </div>
