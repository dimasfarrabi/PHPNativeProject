...
{   
    ...
    if($ValLocation == "PSL")
    {
     ...
     ?>
<div class="row">
    <div class="col-md-12 pt-2"><button class="btn btn-sm btn-dark" data-maxo1="1" data-maxc1="2" data-maxo2="3" data-maxc2="4" id="BtnRecalculateQty">Recalculate Qty Quote All Location</button></div>
    <div class="col-md-12"><hr></div>
    <div class="col-md-12"><div id="ContentInfoRecalculate"></div></div>
    <div class="col-md-12"><div id="CacheTemporary"></div></div>
</div>
