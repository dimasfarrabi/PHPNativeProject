        ...
        <div class="row">
            <div class="col-md-2">
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label for="FieldOldQuote" class="form-label fw-bold">Old Quote</label>
                            <input type="text" class="form-control form-control-sm" id="FieldOldQuote" value="<?php echo trim($RDataDetailWO['Quote']); ?>" readonly>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-group">
                            <label for="FieldTotalTTChangeQuote" class="form-label fw-bold">Jumlah di Time Tracking</label>
                            <input type="text" class="form-control form-control-sm" id="FieldTotalTTChangeQuote" value="<?php echo trim($TotalTTWO); ?>" readonly>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-md-10">
                <div class="row">
                    <div class="col-md-2">
                         <div class="form-group">
                            <label for="FieldNewQuote" class="form-label fw-bold">New Quote</label>
                            <input type="text" class="form-control form-control-sm" id="FieldNewQuote">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-2 pt-2">
                        <button class="btn btn-sm btn-success" id="BtnChangeQuote" data-temp="<?php echo $ValDataTemp; ?>">Change Quote</button>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-2 pt-2" id="InfoChangeQuote"></div>
                </div>
            </div>
        </div>    
    </div>
