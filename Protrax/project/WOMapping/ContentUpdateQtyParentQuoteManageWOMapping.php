        ...
        <div class="row">
            <div class="col-md-2">
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label for="FieldOldQtyParent" class="form-label fw-bold">Old Qty Parent</label>
                            <input type="text" class="form-control form-control-sm" id="FieldOldQtyParent" value="<?php echo (int)trim($RDataDetailWO['QtyParent']); ?>" readonly>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-group">
                            <label for="FieldNewQtyParent" class="form-label fw-bold">New Qty Parent</label>
                            <div class="input-group">
                                <input type="text" class="form-control form-control-sm" id="FieldNewQtyParent">
                            </div>            
                        </div>
                    </div>
                    <div class="col-md-12 pt-2">
                        <button class="btn btn-sm btn-success" id="BtnUpdateQtyParent" data-temp="<?php echo $ValDataTemp; ?>">Update Qty Parent</button>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12 pt-2" id="InfoUpdateQtyPQ"></div>
                </div>
            </div>
        </div>
    </div>
