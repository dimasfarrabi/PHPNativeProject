...
{      
    ...
    // echo "<pre>";print_r($ArrListConst);echo "</pre>";
    # data quality point
    ...
    // echo "<pre>";print_r($ArrDetail);echo "</pre>";
        ...
        <table class="table table-bordered table-hover" id="TableActualDetail">
            ...
            if(count($ArrResult) != "0")
            {
                foreach ($ArrResult as $DataResult)
                {
                    ...
                    // $ValResTotalQtyIn = number_format((float)$ValResTotalQtyIn, 0, '.', ',');
                    // $ValResTotalQtyOut = number_format((float)$ValResTotalQtyOut, 0, '.', ',');
                    ?>
                    <tr>
                        <td class="text-center"><?php echo $No; ?></td>
                        <td class="text-start"><?php echo $ValResDivisionName; ?></td>
