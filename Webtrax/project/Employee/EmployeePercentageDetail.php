...
{   
                    ...
                    case "PSL":
                        {
                            ...
                            while($RListDataEmpDepartment = mssql_fetch_assoc($QListDataEmpDepartment))
                            {
                                ...
                                {
                                    if($ValEmpName == trim($DataEmployee['FN']) && $ValLocation == trim($DataEmployee['Location']) && trim($RListDataEmpDepartment['Department']) == "Administration" && trim($DataEmployee['DivName']) == $ValDivision)
                                    {
                                        $ArrTemp = array(
                    ...
                    case "PSL":
                        {
                            ...
                            while($RListDataEmpDepartment = mssql_fetch_assoc($QListDataEmpDepartment))
                            {
                                ...
                                foreach ($ArrayDataEmployee as $DataEmployee)
                                {
                                    if($ValEmpName == trim($DataEmployee['FN']) && $ValLocation == trim($DataEmployee['Location']) && trim($RListDataEmpDepartment['Department']) == "Engineering" && trim($DataEmployee['DivName']) == $ValDivision)
                                    {
                                        $ArrTemp = array(
                                            "FN" => trim($DataEmployee['FN']),
                                            "NIK" => trim($DataEmployee['NIK']),
    ...
    if(count($ArrayDataEmployeeSelected) > 0)
    {
        ...
        ?>
            <div class="col-md-12"><strong>Employee <?php echo $Location.' Site - '.$ValDivision; ?></strong></div>
            <div class="col-md-12">
            ...
            <div class="modal fade" id="ModalViewResult" tabindex="-1" role="dialog" aria-labelledby="Modal-View" aria-hidden="true">
            <div class="modal-dialog modal-sm" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row" id="ContentResultPic"></div>
                    </div>
                </div>
            </div>
        </div>
