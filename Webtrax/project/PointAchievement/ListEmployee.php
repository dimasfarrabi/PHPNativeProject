...
?>
<style>
    .ListTableEmployee{height: 365px;overflow-y: scroll;}
</style>
...
<div id="ContentEmployee">
    <div class="table-responsive ListTableEmployee">
        <table class="table table-bordered table-hover ListTableCustom" id="ListTableEmp">
            ...
            <tbody><?php
            foreach($ArrayEmployee as $ValArrayEmployee)
            {
                $ValEmployee = trim($ValArrayEmployee['FullName']);
                $ValLocation = trim($ValArrayEmployee['Location']);
                $ValPosition = trim($ValArrayEmployee['Position']);
