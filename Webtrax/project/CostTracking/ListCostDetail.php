...
{   
    ...
    ?>
<div class="col-md-12"><h5><strong>Detail Cost (<?php echo $ValExpense; ?>)</strong></h5></div>
<div class="col-md-12">
    <div class="table-responsive">
        <table class="table table-bordered table-hover" id="TableDetailCost">
            <thead class="theadCustom">
                <tr>
                    <td class="text-center trowCustom" width="30">No</td>
                    <td class="text-center trowCustom" width="80">Name</td>
