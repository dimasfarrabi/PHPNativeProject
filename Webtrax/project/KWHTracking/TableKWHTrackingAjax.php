...
{   
    ...
    # get data tracking
    $BtnDownloadLock = "";
    $QListDataKWHTracking = GET_DATA_KWH_TRACKING_BY_DATE($ValDateStart,$ValDateEnd,$linkHRISWebTrax);
    ...
    ?>
<div class="col-sm-12">
    <h4>Hasil Pencarian Tahun <?php echo $ValDateStart; ?> - <?php echo $ValDateEnd; ?></h4>
</div>
