...
$QListSlave = GET_LIST_SLAVE_V2("PSM",$linkHRISWebTrax);
$NoListSlave = 1;
...
# check row data
$QData2Weeks = GET_LIST_KWH_TRACKING_LOG_BY_DATE_V3($StartTime,$EndTime,"PSM",$linkHRISWebTrax);
...
# check row data
$QListKWHTrackingOneMonth = GET_LIST_KWH_TRACKING_LOG_BY_DATE_V3($LastMonth,$Yesterday,"PSM",$linkHRISWebTrax);
...
$QListKWHTracking2Month = GET_LIST_KWH_TRACKING_LOG_BY_DATE_V3($StartTime,$EndTime,"PSM",$linkHRISWebTrax);
...
$QListKWHTrackingOneYear = GET_LIST_KWH_TRACKING_LOG_BY_DATE_V3($StartTime,$EndTime,"PSM",$linkHRISWebTrax);
