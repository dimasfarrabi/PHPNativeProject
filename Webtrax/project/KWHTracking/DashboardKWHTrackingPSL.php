...
$QListSlave = GET_LIST_SLAVE_V2("PSL",$linkHRISWebTrax);
$NoListSlave = 1;
...
# check row data
$QData2Weeks = GET_LIST_KWH_TRACKING_LOG_BY_DATE_V3($StartTime,$EndTime,"PSL",$linkHRISWebTrax);
...
# check row data
$QListKWHTrackingOneMonth = GET_LIST_KWH_TRACKING_LOG_BY_DATE_V3($LastMonth,$Yesterday,"PSL",$linkHRISWebTrax);
...
$QListKWHTracking2Month = GET_LIST_KWH_TRACKING_LOG_BY_DATE_V3($StartTime,$EndTime,"PSL",$linkHRISWebTrax);
...
$QListKWHTrackingOneYear = GET_LIST_KWH_TRACKING_LOG_BY_DATE_V3($StartTime,$EndTime,"PSL",$linkHRISWebTrax);
