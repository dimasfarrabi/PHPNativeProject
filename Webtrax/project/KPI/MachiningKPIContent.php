...
?>
    ...
    <script type="text/javascript">
        ...
        function drawChart() {
            var data = google.visualization.arrayToDataTable([
                ...
                $Data = GET_DATA_CHART_MACHINING_KPI("PSL",$ValMonth,$linkMACHWebTrax);
    ...
    <script type="text/javascript">
        ...
        function drawChart2() {
            var data = google.visualization.arrayToDataTable([
                ...
                $ValMonth = trim($ArrResult['Month']);
                $ValMonth2 = trim($ArrResult['Month2']);
                $Data = GET_DATA_CHART_MACHINING_KPI("PSM",$ValMonth,$linkMACHWebTrax);
                while($DataRes = sqlsrv_fetch_array($Data))
                {
                    $ValFast = abs(trim($DataRes['DiffMin']));
                    $ValAvg = abs(trim($DataRes['DiffAvg']));
                ...
                <?php
                    ...
                    $Data = GET_DATA_CHART_MACHINING_KPI("PSL",$ValMonth,$linkMACHWebTrax);
                        while($DataRes = sqlsrv_fetch_array($Data))
                        {
                            ...
                            $ValOptForm = '<span class="glyphicon glyphicon-new-window PointerList UpdateRow" aria-hidden="true" data-toggle="modal" data-ecode="'.$RowEnc.'" data-target="#DetailMachineProcess" title="Detail"></span>'
    ...
    <div class="col-md-12">
        <div class="ColumnContent" id="OnRack"></div>
    </div>