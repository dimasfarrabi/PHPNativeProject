...
<script type="text/javascript">
   $("input[name='RadioFilter']").click(function() { 
    ...
    function Search() {
        ...
        $.ajax({
            url: 'project/reconciliation/SyncReconContent.php',
            dataType: 'text',
            cache: false,
            contentType: false,
            processData: false,
            ...
            beforeSend: function () {
                $('#SyncTable').html("");
                $("#SyncTable").before('<div class="col-sm-12" id="ContentLoadingTT"><img src="../images/ajax-loader1.gif" id="LoadingCheck" class="load_img"/></div>');
                $('#SyncTable').html("");
            },
